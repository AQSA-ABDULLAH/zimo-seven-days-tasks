          ...
          <section autoComplete="off" className="flex flex-col flex-1 items-center space-y-2 text-[18px] lg:text-[16px]">
            ...
            <section className="relative max-w-[720px] w-[90%] h-[335px]">
              ...
              <div className="absolute bottom-0 -right-44 block lg:hidden">
                <button className="lg:hidden h-[120px] w-[120px] bg-white text-black tracking-widest text-[14px] mb-4 rounded-xl flex items-center text-center justify-center border-black border border-opacity-60">
                  CANCEL
                </button>
            ...
            <div className="flex justify-around w-full pt-8">
              ...
              <button className="lg:flex hidden h-[120px] w-[120px] bg-white text-black tracking-widest text-[14px] mb-4 rounded-xl items-center text-center justify-center border-black border border-opacity-60">
                CANCEL
              </button>
            </div>
          </section>
